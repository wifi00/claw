...
const UUID = process.env.UUID || '4f717854-580c-44b7-b891-72e2c3a4fbb0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.siginaak.cf';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '443';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'KZEMo9lxatftL9klMx';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'claw.poiuyd.eu.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"399391cd02de65ae54923aa75994c72e","TunnelSecret":"TDIYByPHKMqPabdOMxa2etL5AHOyyJrBXxamzkeTo1M=","TunnelID":"34a62457-2052-4f36-9951-52822470f320","Endpoint":""}';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
